...
const features = [
  {
    ...
    description: "Beat the ATS with AI-driven analysis and keyword optimization.",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Practice with realistic AI simulations and get instant feedback.",
    icon: MessageSquare,
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-4 md:p-24 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-8">
          Optimize your resume, craft perfect cover letters, and master your interviews.
          All in one platform designed to get you hired.
        </p>
