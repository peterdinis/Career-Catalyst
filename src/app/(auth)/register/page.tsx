            ...
            <div className="space-y-2">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400 space-y-1 pl-1">
                ...
                <ul className="list-disc list-inside space-y-0.5">
                  <li className={errors.password?.message?.includes('uppercase') ? 'text-red-500' : ''}>
                    At least one uppercase letter
                  </li>
                  <li className={errors.password?.message?.includes('lowercase') ? 'text-red-500' : ''}>
                    At least one lowercase letter
                  </li>
                  <li className={errors.password?.message?.includes('number') ? 'text-red-500' : ''}>
                    At least one number
                  </li>
                  <li className={errors.password?.message?.includes('6 characters') ? 'text-red-500' : ''}>
              ...
              {errors.password && (
                <p id="password-error" className="text-sm text-red-500 flex items-center gap-1 mt-2">
