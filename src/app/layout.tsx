...
export const metadata: Metadata = {
    ...
    description:
        'Transform your career with AI-powered tools. Optimize your resume, generate personalized cover letters, and practice interviews with our intelligent career assistant. Get hired faster with CareerCatalyst.',
    keywords: [
        'AI career assistant',
        'resume optimizer',
