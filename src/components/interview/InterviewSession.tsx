...
import { Send, User, Bot, ThumbsUp, AlertCircle, Lightbulb } from "lucide-react";
        ...
        <div className="flex flex-col h-[700px] w-full max-w-4xl mx-auto glass-card rounded-2xl overflow-hidden">
            ...
            <div className="p-4 border-b border-white/10 bg-white/5 flex items-center justify-between">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">{config.companyType} • {config.round}</p>
                </div>
                        ...
                        {msg.role === "assistant" && msg.feedback && (
                            ...
                            >
                                <div className="flex items-center gap-2 text-primary font-medium border-b border-white/10 pb-2 mb-2">
                                    <Lightbulb className="h-4 w-4" /> Feedback on your answer
                                </div>
                                ...
                                <div className="bg-white/5 p-3 rounded-lg">
                                    <p className="text-xs font-semibold text-muted-foreground mb-1">Better Answer Example:</p>
                                    <p className="text-xs italic text-white/80">"{msg.feedback.betterAnswer}"</p>
                                </div>
                            </motion.div>
                        )}
                    </div>
